                ...
                <div className="hero-body">
                   <div className="columns ">
                    <div className="column is-half">
                        ...
                        <div className="is-size-4-fullhd is-size-5-mobile">
                        Using our custom pokkalam design tool create beautiful designs easily 
                        </div>
                        <div className="column has-text-left mt-3 m-0 p-0">
                        
                            <button className="button CButton is-primary is-rounded mr-4 is-size-5">Gallery</button>
                            <button className="button CButton is-primary is-rounded ml-4 is-size-5">Create</button>
                    ...
                    <div className="column landingImage is-full has-text-centered">
                        <div>
